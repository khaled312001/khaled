...
@section('title', 'Web Development Services — Laravel, React, Node.js, Hosting & Training | Khaled Ahmed')
@section('description', 'Hire a senior full stack developer. Services: custom web apps with Laravel & Node.js, React frontends, e-commerce builds, SEO-ready websites, web hosting & DevOps, and 1-on-1 coding mentorship. 5+ years, 25+ shipped projects, 7 countries.')
@section('keywords', 'web development services, hire full stack developer, Laravel developer, React developer, Node.js developer, web hosting services, DevOps services, coding mentor, programming instructor, e-commerce developer, custom web application, SEO web development, Khaled Ahmed services')
@section('canonical', 'https://khaledahmed.net/services')
@section('og_title', 'Web Development Services — Laravel, React & Node.js by Khaled Ahmed')
@section('og_description', 'Custom web apps, e-commerce, hosting/DevOps, and coding mentorship from a senior full stack developer with 25+ shipped projects.')
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="breadcrumb-inner">
                    <h1>{{ __('site.page_services_h1') }}</h1>
                    <ul class="breadcrumb-links">
                        <li><a href="{{ route('home') }}">{{ __('site.home') }}</a></li>
                        <li class="active">{{ __('site.page_services_h1') }}</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="section-heading text-center">
                    <span class="section-badge"><i class="fas fa-bolt"></i> {{ __('site.page_services_h1') }}</span>
                    <h2 class="section-title-h2">{{ __('site.services_what_offer') }}</h2>
                </div>
            </div>
        </div>
        <div class="row">
...
<section class="container">
    <div class="services-cta">
        ...
        <a href="{{ route('contact') }}">Start a project <i class="fa fa-arrow-right ms-2"></i></a>
    </div>
</section>
...
<section class="section pt-0">
    <div class="container">
        <div class="row g-4">
            <div class="col-md-4">
                <a href="{{ route('portfolios') }}" style="display:block;padding:24px;background:#fff;border:1px solid #e5e7eb;border-radius:12px;text-decoration:none;color:inherit;height:100%;">
            ...
            <div class="col-md-4">
                <a href="{{ route('blogs') }}" style="display:block;padding:24px;background:#fff;border:1px solid #e5e7eb;border-radius:12px;text-decoration:none;color:inherit;height:100%;">
            ...
            <div class="col-md-4">
                <a href="{{ route('faqs') }}" style="display:block;padding:24px;background:#fff;border:1px solid #e5e7eb;border-radius:12px;text-decoration:none;color:inherit;height:100%;">
