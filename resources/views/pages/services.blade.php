...
<section class="ks-section ks-section--tight" style="background: rgba(255,255,255,0.02);">
    <div class="container">
        <div class="ks-shead">
            ...
            <p>{{ $isAr ? 'بدون عقود معقدة. نفس الخطوات التي اتبعتها في كل واحد من 39+ مشروع نشرتهم.' : 'No 10-page contracts. The same four steps I used for every one of my 39+ shipped projects.' }}</p>
        </div>
    ...
    <div class="container">
        ...
        <div class="svc-faq" style="max-width: 820px; margin: 0 auto;">
            @foreach([
                ...
                [$isAr ? 'هل تعمل مع عملاء دوليين؟' : 'Do you work with international clients?',                  $isAr ? 'نعم، نشرت أكثر من 39 مشروعاً في 8 دول (مصر، السعودية، الإمارات، الكويت، قطر، المملكة المتحدة، سويسرا، ألمانيا). التواصل بالإنجليزية أو العربية وتحديثات يومية واحترام فروق التوقيت.' : 'Yes — 39+ shipped projects across 8 countries (Egypt, Saudi, UAE, Kuwait, Qatar, UK, Switzerland, Germany). English or Arabic, daily updates, time-zone aware.'],
