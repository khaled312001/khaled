...
<section class="hero-banner" data-scroll-index="1">
    <div class="container">
        <div class="row">
            <div class="col-lg-9">
                <h1>{{ __('site.hero_title_1') }} <span>{{ __('site.hero_title_2') }}</span> {{ __('site.hero_title_3') }}</h1>
                <h2>{{ __('site.hero_subtitle') }}</h2>
                ...
                <div class="about-inner wow fadeInUp">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <ul class="mb-resp-15">
                                <li><div class="text"><h5>{{ __('site.name_label') }}</h5><p>{{ __('site.name_value') }}</p></div></li>
                                <li><div class="text"><h5>{{ __('site.location_label') }}</h5><p>{{ __('site.location_value') }}</p></div></li>
                                <li><div class="text"><h5>{{ __('site.freelance_label') }}</h5><p>{{ __('site.freelance_value') }}</p></div></li>
                            </ul>
                        </div>
                        <div class="col-md-6 col-sm-6">
                            <ul>
                                <li><div class="text"><h5>{{ __('site.education_label') }}</h5><p>{{ __('site.education_value') }}</p></div></li>
                                <li><div class="text"><h5>{{ __('site.languages_label') }}</h5><p>{{ __('site.languages_value') }}</p></div></li>
                                <li><div class="text"><h5>{{ __('site.phone_label') }}</h5><p><a href="tel:+201204593124" class="text-decoration-none text-dark">+20 120 459 3124</a> · <a href="tel:+201010254819" class="text-decoration-none text-dark">+20 101 025 4819</a></p></div></li>
                            </ul>
                        </div>
                    </div>
