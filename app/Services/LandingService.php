    ...
    private static function pages(): array
    {
        return [
            'hire-laravel-developer' => [
                ...
                'meta_title_ar' => 'وظّف مطور لارافيل خبير | خبرة 5 سنوات و25 مشروعاً',
                ...
                'meta_description_ar' => 'وظّف مطور لارافيل خبير بخبرة تتجاوز 5 سنوات و25 مشروعاً منجزاً في 8 دول. واجهات برمجية ولوحات تحكم ونسخ أولية احترافية بدءاً من 30 دولاراً للساعة.',
                'h1' => 'Hire a Laravel Developer Who Ships Production-Ready Apps',
                'h1_ar' => 'وظّف مطور لارافيل يبني تطبيقات جاهزة للإطلاق',
                ...
                'deliverables_ar' => [
                    'تطبيقات لارافيل مخصّصة تُبنى من الصفر بكود نظيف وموثّق',
                    ...
                    'ترقية مشاريع لارافيل القديمة وإصلاح الأخطاء وإنقاذ الكود وإعادة هيكلته',
                ...
                'why_html_ar' => '<p>عندما توظّف مطور لارافيل، فأنت في الحقيقة تشتري حسن التقدير: معرفة أي حزمة تستحق الثقة، ومتى تلجأ إلى التخزين المؤقت، وكيف تُبقي قاعدة البيانات سريعة عند التوسع. لقد اتخذت هذه القرارات في أكثر من 25 مشروعاً حقيقياً، منها منصات تجارة إلكترونية وأنظمة لوجستية وتطبيقات توصيل، وأسست شركة برمجلي لمساعدة الفرق على بناء البرمجيات بالطريقة الصحيحة. أنت تحصل على مهندس أول، لا على مبتدئ يتعلّم على حسابك.</p><p>التواصل هو ما يُفشل معظم علاقات العمل الحر، لذلك أبالغ فيه: نطاق واضح منذ البداية، وتحديثات قصيرة غير متزامنة، ونموذج يعمل يمكنك تجربته كل أسبوع. أعمل بمرونة عبر توقيت الخليج والغرب، وأردّ خلال ساعات، ولا أختفي في منتصف المشروع أبداً. توظيف مطور لارافيل خبير يجب أن يكون تجربة مريحة لا مصدر توتر.</p><p>أسعاري شفافة، تتراوح غالباً بين 30 و60 دولاراً في الساعة حسب النطاق، أو بسعر ثابت بعد تحديد المتطلبات. وتستغرق النسخة الأولية المركزة عادةً من 8 إلى 16 أسبوعاً. هذا المزيج من الخبرة العالية والتسعير الصادق والتسليم الموثوق هو سبب عودة العملاء إليّ.</p>',
                ...
                'faq_ar' => [
                    ['q' => 'ما تكلفة توظيف مطور لارافيل؟', 'a' => 'يتراوح سعري عادةً بين 30 و60 دولاراً في الساعة حسب تعقيد العمل ومستواه. وللمشاريع المحددة المعالم أقدّم سعراً ثابتاً بعد الاتفاق على النطاق، لتعرف التكلفة الإجمالية مسبقاً دون مفاجآت. قد تكلّف واجهة برمجية صغيرة بضعة آلاف من الدولارات، بينما تكون النسخة الأولية الكاملة أكبر. سأمنحك دائماً تقديراً صادقاً قبل أن أبدأ.'],
                    ['q' => 'كم يستغرق بناء نسخة أولية بلارافيل؟', 'a' => 'تستغرق النسخة الأولية المركزة عادةً بين 8 و16 أسبوعاً، بحسب عدد الميزات وعمليات الربط وسرعة تزويدك بالملاحظات. أقسّم العمل إلى مراحل أسبوعية، وأسلّم في نهاية كل مرحلة نموذجاً قابلاً للتجربة، لترى التقدّم بدل الانتظار لأشهر. أما الواجهات البرمجية أو لوحات التحكم البسيطة فيمكن تسليمها خلال أسبوعين إلى أربعة.'],
                    ...
                    ['q' => 'هل تبني واجهات برمجية بلارافيل لتطبيقات الجوال؟', 'a' => 'بالتأكيد، فتطوير واجهات لارافيل البرمجية من صميم خدماتي. أبني واجهات REST أو JSON نظيفة ومؤمّنة عبر Sanctum أو Passport، مع تحديد للمعدل والتحقق من المدخلات وتوثيق واضح يستطيع فريقك استهلاكه فوراً. شغّلت تطبيقات iOS وأندرويد وفلاتر وReact/Vue بخلفيات لارافيل.'],
                    ['q' => 'هل يمكنك إصلاح مشروع لارافيل قائم أو استلامه؟', 'a' => 'نعم، استلام مشاريع لارافيل القائمة أمر أقوم به كثيراً. أبدأ بمراجعة سريعة للكود وقاعدة البيانات والاعتماديات، ثم أمنحك تقريراً صادقاً عمّا هو متين وما هو محفوف بالمخاطر. بعدها أستطيع إصلاح الأخطاء العاجلة أو ترقية إصدار لارافيل القديم أو إعادة هيكلة الأجزاء المتشابكة أو إضافة ميزات جديدة.'],
