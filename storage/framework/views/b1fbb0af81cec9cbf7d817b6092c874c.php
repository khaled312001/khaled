<?php $__env->startSection('title', app()->getLocale() === 'ar' ? 'عن خالد أحمد — مطور Laravel و React من القاهره' : 'About Khaled Ahmed — Laravel & React Developer, Cairo'); ?>
<?php $__env->startSection('description', app()->getLocale() === 'ar' ? 'خمس سنوات و40 مشروعا في بيئه الإنتاج عبر 8 دول، و8 تطبيقات على Google Play. كيف أعمل، وكم أتقاضى، وأي المشاريع أعتذر عنها.' : 'Five years, 40 production builds across 8 countries, 8 apps on Google Play. How I work, what I charge, and the projects I turn down.'); ?>
<?php $__env->startSection('keywords', 'Khaled Ahmed web developer, about Khaled Ahmed, Laravel expert Cairo, React developer Egypt, senior full stack developer, خالد أحمد مطور ويب'); ?>
...
<section class="about-hero">
    <div class="container">
        <div class="about-bread">
            ...
            <i class="fas fa-chevron-<?php echo e(app()->getLocale() === 'ar' ? 'left' : 'right'); ?>"></i>
            <span><?php echo e(app()->getLocale() === 'ar' ? 'عن خالد' : 'About'); ?></span>
        </div>
        <span class="ks-eyebrow"><span class="ks-dot"></span> <?php echo e(app()->getLocale() === 'ar' ? 'تعرف علي' : 'Get to know me'); ?></span>
        <h1><?php echo e(app()->getLocale() === 'ar' ? 'أنا خالد أحمد، أصمم وأبني تطبيقات ويب' : 'I am Khaled Ahmed — I design and ship web applications'); ?> <span class="ks-grad-text"><?php echo e(app()->getLocale() === 'ar' ? 'تعمل فعلا' : 'that actually ship'); ?></span></h1>
        <p class="lead"><?php echo e(app()->getLocale() === 'ar' ? 'مطور ويب Full Stack من القاهرة بأكثر من خمس سنوات من الخبرة العملية. سلمت 25 مشروع إنتاج في 8 دول، من شركات ناشئة سعودية إلى وكالات أوروبية. تخصصي: Laravel و React و Node.js وتصميم البنية القابلة للتوسع.' : 'Cairo-based full stack web developer with 5+ years of hands-on experience. Shipped 25+ production projects across 8 countries — from Saudi startups to European agencies. Specialized in Laravel, React, Node.js, and scalable architecture.'); ?></p>
    </div>
</section>
...
<section class="ks-section ks-section--tight">
    <div class="container">
        <div class="row g-5 align-items-start">
            <div class="col-lg-7">
                <h2><?php echo e(app()->getLocale() === 'ar' ? 'نبذة عني' : 'A bit about me'); ?></h2>
                ...
                <div class="d-flex flex-wrap gap-2 mt-4">
                    ...
                    <a href="/Khaled_Ahmed.pdf" class="ks-btn ks-btn--ghost" download><i class="fa fa-download"></i> <?php echo e(app()->getLocale() === 'ar' ? 'تحميل السيرة الذاتية' : 'Download CV'); ?></a>
                </div>
            ...
            <div class="col-lg-5">
                <div class="ks-media ks-fadeup" style="margin-bottom: 20px;">
                    <img src="<?php echo e(asset('images/site/about-developer.webp')); ?>"
                         alt="<?php echo e(app()->getLocale() === 'ar' ? 'مساحة عمل مطور ويب خبير — أكواد وشاشات وتصميم معماري' : 'Senior web developer workspace — clean code, multiple monitors, architecture'); ?>"
                         width="1536" height="1024" loading="lazy" decoding="async">
                </div>
                <div class="about-info">
                    <div class="about-info__row"><div class="about-info__lbl"><?php echo e(app()->getLocale() === 'ar' ? 'الاسم' : 'Name'); ?></div><div class="about-info__val">Khaled Ahmed</div></div>
                    <div class="about-info__row"><div class="about-info__lbl"><?php echo e(app()->getLocale() === 'ar' ? 'الموقع' : 'Location'); ?></div><div class="about-info__val"><?php echo e(app()->getLocale() === 'ar' ? 'القاهرة، مصر' : 'Cairo, Egypt'); ?></div></div>
                    <div class="about-info__row"><div class="about-info__lbl"><?php echo e(app()->getLocale() === 'ar' ? 'العمل الحر' : 'Freelance'); ?></div><div class="about-info__val" style="color:var(--success);"><i class="fas fa-circle" style="font-size:8px;"></i> <?php echo e(app()->getLocale() === 'ar' ? 'متاح' : 'Available'); ?></div></div>
                    <div class="about-info__row"><div class="about-info__lbl"><?php echo e(app()->getLocale() === 'ar' ? 'التعليم' : 'Education'); ?></div><div class="about-info__val">Luxor University · ITI Diploma</div></div>
                    <div class="about-info__row"><div class="about-info__lbl"><?php echo e(app()->getLocale() === 'ar' ? 'اللغات' : 'Languages'); ?></div><div class="about-info__val"><?php echo e(app()->getLocale() === 'ar' ? 'العربية والإنجليزية' : 'English & Arabic'); ?></div></div>
                    <div class="about-info__row"><div class="about-info__lbl"><?php echo e(app()->getLocale() === 'ar' ? 'الهاتف' : 'Phone'); ?></div><div class="about-info__val" dir="ltr"><a href="tel:+201204593124">+20 120 459 3124</a></div></div>
                </div>
            </div>
        </div>
    </div>
...
<section class="ks-section ks-section--tight" style="background: rgba(255,255,255,0.02);">
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-6">
                <span class="ks-eyebrow"><?php echo e(app()->getLocale() === 'ar' ? 'المسيرة' : 'Career'); ?></span>
                <h2 class="mt-3"><?php echo e(app()->getLocale() === 'ar' ? 'الخبرة المهنية' : 'Professional experience'); ?></h2>
                <div class="about-tl">
                    <?php
                    $jobs = [
                    ...
                    ?>
                    <?php $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$co, $role, $when]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="about-tl__item ks-fadeup">
                            <div class="about-tl__co"><?php echo e($co); ?></div>
                            <div class="about-tl__role"><?php echo e($role); ?></div>
                            <div class="about-tl__when"><?php echo e($when); ?></div>
                        </div>
            ...
            <div class="col-lg-6">
                <span class="ks-eyebrow"><?php echo e(app()->getLocale() === 'ar' ? 'التعليم' : 'Education'); ?></span>
                <h2 class="mt-3"><?php echo e(app()->getLocale() === 'ar' ? 'الخلفية الأكاديمية' : 'Academic background'); ?></h2>
                <div class="about-tl">
                    <div class="about-tl__item ks-fadeup">
                        <div class="about-tl__co">LUXOR UNIVERSITY</div>
                        <div class="about-tl__role"><?php echo e(app()->getLocale() === 'ar' ? 'بكالوريوس تكنولوجيا المعلومات' : 'BSc in Information Technology'); ?></div>
                        <div class="about-tl__when"><?php echo e(app()->getLocale() === 'ar' ? '2018 — 2022 · الأقصر، مصر' : '2018 — 2022 · Luxor, Egypt'); ?></div>
                    </div>
                    <div class="about-tl__item ks-fadeup">
                        <div class="about-tl__co">ITI — INFORMATION TECHNOLOGY INSTITUTE</div>
                        <div class="about-tl__role"><?php echo e(app()->getLocale() === 'ar' ? 'دبلومة التطوير الشامل (PHP / Laravel)' : 'Full Stack Development Diploma (PHP / Laravel)'); ?></div>
                        <div class="about-tl__when"><?php echo e(app()->getLocale() === 'ar' ? 'مسار مكثف · مصر' : 'Intensive Track · Egypt'); ?></div>
                    </div>
                </div>

                <h2 class="mt-5"><?php echo e(app()->getLocale() === 'ar' ? 'مستويات المهارة' : 'Skill levels'); ?></h2>
                <div class="d-flex flex-column gap-3">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$name, $pct]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="about-skill ks-fadeup" style="--pct: <?php echo e($pct); ?>%;">
                            <div class="about-skill__head"><span class="about-skill__name"><?php echo e($name); ?></span><span class="about-skill__pct"><?php echo e($pct); ?>%</span></div>
...
<section class="ks-section ks-section--tight">
    <div class="container">
        <div class="ks-shead ks-fadeup">
            <span class="ks-eyebrow"><?php echo e(app()->getLocale() === 'ar' ? 'الأدوات' : 'Stack'); ?></span>
            <h2><?php echo e(app()->getLocale() === 'ar' ? 'التقنيات والأدوات' : 'Technologies & tools'); ?></h2>
        </div>
...
<section class="ks-section ks-section--tight">
    <div class="container">
        <div class="home-cta ks-fadeup">
            <h2><?php echo e(app()->getLocale() === 'ar' ? 'هل لديك مشروع في بالك؟' : 'Have a project in mind?'); ?></h2>
            <p><?php echo e(app()->getLocale() === 'ar' ? 'استشارة مجانية لمدة 30 دقيقة، وعرض ثابت السعر خلال 24 ساعة، ودون أي مكالمات مبيعات.' : 'Free 30-minute discovery call, fixed-fee quote within 24 hours, no sales calls — ever.'); ?></p>
            <div class="home-cta__row">
                <a href="<?php echo e(route('contact')); ?>" class="ks-btn ks-btn--primary"><?php echo e(app()->getLocale() === 'ar' ? 'احجز استشارة' : 'Book a consultation'); ?> <i class="fa fa-arrow-right"></i></a>
