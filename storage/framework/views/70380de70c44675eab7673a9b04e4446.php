...
<?php $__env->startSection('title', app()->getLocale() === 'ar' ? 'باقات الصيانه والدعم — ما الذي تشمله فعليا' : 'Maintenance & Support Plans — What\'s Actually Included'); ?>
<?php $__env->startSection('description', app()->getLocale() === 'ar' ? 'اشتراكات شهريه للتحديثات وترقيعات الأمان والنسخ الاحتياطي والإصلاحات. ساعات واضحه، بلا ارتباط طويل، ويمكن الإلغاء أي شهر.' : 'Monthly retainers for updates, security patches, backups and fixes. Transparent hours, no lock-in, cancel any month.'); ?>
<?php $__env->startSection('keywords', 'website maintenance plans monthly, what is included in website maintenance, website support retainer, web development pricing, باقات صيانة المواقع, أسعار تصميم المواقع'); ?>
...
<section class="pl-hero">
    <div class="container">
        <span class="ks-eyebrow"><span class="ks-dot"></span> <?php echo e($isAr ? 'أسعار شفافة' : 'Transparent pricing'); ?></span>
        <h1 class="mt-3"><?php echo e($isAr ? 'باقات تناسب كل مشروع' : 'Plans that fit every project'); ?></h1>
        <p class="lead"><?php echo e($isAr ? 'ثلاث باقات بأسعار ثابتة لكل احتياج، من موقع تسويقي إلى منصة SaaS كاملة. كل شيء يشمل ضمان 30 يوم ودعم ما بعد الإطلاق.' : 'Three fixed-fee plans for every need, from a marketing site to a full SaaS platform. Everything includes a 30-day warranty and post-launch support.'); ?></p>
    </div>
</section>
        ...
        <div class="row g-4">
            ...
            <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-6 col-lg-4 ks-fadeup">
                    <div class="pl-card <?php echo e($p['featured'] ? 'pl-card--featured' : ''); ?>">
                        <?php if($p['featured']): ?><div class="pl-card__badge"><?php echo e($isAr ? 'الأكثر طلبا' : 'Most popular'); ?></div><?php endif; ?>
                        <div class="pl-card__ico"><i class="<?php echo e($p['icon']); ?>"></i></div>
                        <h3><?php echo e($p['name']); ?></h3>
                        <p class="pl-card__desc"><?php echo e($p['desc']); ?></p>
                        <div class="pl-card__price">
                            <span class="num"><span><?php echo e($p['price']); ?></span></span>
                            <span class="per"><?php echo e($p['per']); ?></span>
                        </div>
                        <ul class="pl-card__features">
                            <?php $__currentLoopData = $p['features']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$txt, $on]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="<?php echo e($on ? '' : 'is-off'); ?>"><i class="fas fa-<?php echo e($on ? 'check' : 'times'); ?>"></i> <?php echo e($txt); ?></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                        <a href="<?php echo e(route('contact')); ?>" class="ks-btn <?php echo e($p['featured'] ? 'ks-btn--primary' : 'ks-btn--ghost'); ?>">
                            <?php echo e($isAr ? 'احصل على عرض' : 'Get a quote'); ?> <i class="fa fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="row mt-5">
            <div class="col-lg-6">
                <div class="pl-faq ks-fadeup">
                    <h3><?php echo e($isAr ? 'لماذا الأسعار تبدأ من؟' : 'Why do prices start at?'); ?></h3>
                    <p><?php echo e($isAr ? 'لأن كل مشروع له نطاق مختلف. السعر النهائي بعد مكالمه الاستكشاف 30 دقيقه (مجانيه) وقبل أي عمل، تستلم عرضا ثابت السعر مكتوبا.' : 'Every project has a different scope. The final price is set after a free 30-minute discovery call. Before any work starts, you receive a written fixed-fee proposal.'); ?></p>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="pl-faq ks-fadeup">
                    <h3><?php echo e($isAr ? 'الصيانه بعد الإطلاق؟' : 'Maintenance after launch?'); ?></h3>
                    <p><?php echo e($isAr ? 'عقود شهرية تبدأ من $200/شهر للمواقع الصغيره وحتى $800/شهر للتطبيقات النشطه. تشمل التحديثات والنسخ الاحتياطي والمراقبه وتغييرات صغيره.' : 'Monthly retainers start at $200/mo for small sites up to $800/mo for active web apps. Includes updates, backups, monitoring, and small change requests.'); ?></p>
                </div>
            </div>
        </div>

        <div class="home-cta ks-fadeup" style="margin-top: var(--sp-7);">
            <h2><?php echo e($isAr ? 'مش لاقي الباقه المناسبة؟' : 'Not sure which plan fits?'); ?></h2>
            <p><?php echo e($isAr ? 'احجز مكالمه استكشاف 30 دقيقه مجانية، وسأقترح عليك الباقه المناسبة لمشروعك.' : 'Book a free 30-minute discovery call and I will recommend the right plan for your project.'); ?></p>
            <div class="home-cta__row">
                <a href="<?php echo e(route('contact')); ?>" class="ks-btn ks-btn--primary"><?php echo e($isAr ? 'احجز مكالمه' : 'Book a call'); ?> <i class="fa fa-arrow-right"></i></a>
                <a href="<?php echo e(route('faqs')); ?>" class="ks-btn ks-btn--ghost"><?php echo e($isAr ? 'الأسئلة الشائعة' : 'See FAQs'); ?> <i class="fa fa-arrow-right"></i></a>
            </div>
        </div>
    </div>
</section>
