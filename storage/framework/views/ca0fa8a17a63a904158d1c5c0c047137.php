...
<?php $__env->startSection('canonical', isset($category) ? 'https://khaledahmed.net/blog/category/' . strtolower($category) : 'https://khaledahmed.net/blogs'); ?>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <article class="blog-card" itemscope itemtype="https://schema.org/BlogPosting">
                    <div class="blog-body">
                        <span class="cat-pill" itemprop="articleSection"><?php echo e($post['category']); ?></span>
                        <h3 itemprop="headline">
                            <a href="<?php echo e(route('blog.show', $post['slug'])); ?>" itemprop="url"><?php echo e($post['title']); ?></a>
                        </h3>
                        <div class="meta">
                            <i class="far fa-calendar"></i>
                            <time datetime="<?php echo e($post['date']); ?>" itemprop="datePublished"><?php echo e(\Carbon\Carbon::parse($post['date'])->locale(app()->getLocale())->translatedFormat(app()->getLocale() === 'ar' ? 'd F Y' : 'M d, Y')); ?></time>
                            &nbsp;&bull;&nbsp;
                            <i class="far fa-clock"></i> <?php echo e($post['read_time']); ?>

                        </div>
                        <p itemprop="description"><?php echo e($post['excerpt']); ?></p>
                        <a href="<?php echo e(route('blog.show', $post['slug'])); ?>" class="read-more">
                            <?php echo e(__('site.read_full_article')); ?> <i class="fa fa-arrow-right"></i>
                        </a>
                    </div>
                </article>
            </div>
