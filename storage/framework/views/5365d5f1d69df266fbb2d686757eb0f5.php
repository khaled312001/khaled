...
<?php $__env->startSection('title', $mTitle); ?>
<?php $__env->startSection('description', $mDesc); ?>
<?php $__env->startSection('keywords', $page['keywords'] ?? ''); ?>

<?php $__env->startSection('structured_data'); ?>
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"Service","serviceType":<?php echo json_encode($page['service_type'] ?? $page['h1'], 15, 512) ?>,"provider":{"@type":"Person","name":"Khaled Ahmed","jobTitle":"Senior Full Stack Web Developer","url":"https://khaledahmed.net","sameAs":["https://linkedin.com/in/khaled-ahmed-82368819b","https://github.com/khaled312001"]},"areaServed":["SA","AE","KW","QA","EG","GB","US","DE","CH","FR"],"url":"https://khaledahmed.net/<?php echo e($page['slug']); ?>","description":<?php echo json_encode($page['meta_description'], 15, 512) ?>}
</script>
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[<?php $__currentLoopData = ($faq ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>{"@type":"Question","name":<?php echo json_encode($f['q'], 15, 512) ?>,"acceptedAnswer":{"@type":"Answer","text":<?php echo json_encode($f['a'], 15, 512) ?>}}<?php if(!$loop->last): ?>,<?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>]}
</script>
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"<?php echo e(route('home')); ?>"},{"@type":"ListItem","position":2,"name":"Services","item":"<?php echo e(route('services')); ?>"},{"@type":"ListItem","position":3,"name":<?php echo json_encode($page['h1'], 15, 512) ?>,"item":"<?php echo e(route('landing', $page['slug'])); ?>"}]}
</script>
...
<section class="lp-hero">
    <div class="container">
        <div class="d-inline-flex align-items-center gap-2 mb-3" style="font-size:13px;color:var(--text-3);">
            ...
            <a href="<?php echo e(route('services')); ?>" style="color:var(--text-2);text-decoration:none;"><?php echo e($isAr ? 'الخدمات' : 'Services'); ?></a>
            <i class="fas fa-chevron-<?php echo e($isAr ? 'left' : 'right'); ?>" style="font-size:10px;color:var(--text-4);"></i>
            <span><?php echo e($isAr ? ($page['nav_ar'] ?? $page['nav'] ?? '') : ($page['nav'] ?? '')); ?></span>
        </div>
        <span class="ks-eyebrow"><span class="ks-dot"></span> <?php echo e($isAr ? 'متاح لمشاريع جديدة' : 'Available for new projects'); ?></span>
        <h1 class="mt-3"><?php echo e($h1); ?></h1>
        <p class="lp-sub"><?php echo e($heroSub); ?></p>
        <div class="lp-cta-row">
            <a href="<?php echo e(route('contact')); ?>" class="ks-btn ks-btn--primary"><?php echo e($isAr ? 'احصل على عرض سعر' : 'Get a free quote'); ?> <i class="fa fa-arrow-right"></i></a>
            <a href="<?php echo e(route('portfolios')); ?>" class="ks-btn ks-btn--ghost"><?php echo e($isAr ? 'شاهد أعمالي' : 'See my work'); ?> <i class="fa fa-arrow-right"></i></a>
        </div>
        <div class="ks-stats mt-5" style="max-width:720px;">
            <div class="ks-stat"><div class="ks-stat__num">25+</div><div class="ks-stat__lbl"><?php echo e($isAr ? 'مشروع' : 'Projects'); ?></div></div>
            <div class="ks-stat"><div class="ks-stat__num">8</div><div class="ks-stat__lbl"><?php echo e($isAr ? 'دول' : 'Countries'); ?></div></div>
            <div class="ks-stat"><div class="ks-stat__num">5+</div><div class="ks-stat__lbl"><?php echo e($isAr ? 'سنوات' : 'Years'); ?></div></div>
            <div class="ks-stat"><div class="ks-stat__num">24h</div><div class="ks-stat__lbl"><?php echo e($isAr ? 'رد' : 'Response'); ?></div></div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <?php if(!empty($page['image'])): ?>
            <div class="row g-5 align-items-center">
                <div class="col-lg-7">
                    <div class="lp-intro ks-fadeup"><?php echo $intro; ?></div>
                </div>
                <div class="col-lg-5">
                    <div class="ks-media ks-fadeup">
                        <img src="<?php echo e(asset('images/' . $page['image'])); ?>"
                             alt="<?php echo e($page['image_alt'] ?? $page['h1']); ?>"
...
<section class="ks-section ks-section--tight" style="background: rgba(255,255,255,0.02);">
    <div class="container">
        <div class="ks-shead" style="text-align:start;margin-bottom:var(--sp-5);">
            <h2><?php echo e($isAr ? 'ما الذي تحصل عليه' : 'What you get'); ?></h2>
        </div>
        <div class="lp-deliver ks-fadeup">
            <?php $__currentLoopData = $deliver; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="lp-deliver__item"><i class="fas fa-check-circle"></i> <span><?php echo e($d); ?></span></div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <div class="mt-5">
            <h3 style="font-size:18px;margin-bottom:16px;"><?php echo e($isAr ? 'التقنيات المستخدمة' : 'Tech stack'); ?></h3>
            <div class="lp-tech">
                <?php $__currentLoopData = ($page['tech'] ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><span><?php echo e($t); ?></span><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
    </div>
</section>
...
<section class="ks-section ks-section--tight">
    <div class="container">
        <div class="ks-shead" style="text-align:start;margin-bottom:var(--sp-5);">
            <h2><?php echo e($isAr ? 'لماذا تعمل معي' : 'Why work with me'); ?></h2>
        </div>
        <div class="lp-why ks-fadeup"><?php echo $why; ?></div>
    </div>
</section>
...
<section class="ks-section ks-section--tight" style="background: rgba(255,255,255,0.02);">
    <div class="container">
        <div class="ks-shead" style="text-align:start;margin-bottom:var(--sp-5);">
            <h2><?php echo e($isAr ? 'أعمال ذات صلة' : 'Related work'); ?></h2>
            <p style="margin:0;"><?php echo e($isAr ? 'مشاريع حقيقية منشورة في نفس المجال.' : 'Real shipped projects in this space.'); ?></p>
        </div>
        <div class="row g-4">
            <?php $__currentLoopData = $related; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-4 col-md-6 ks-fadeup">
                    <?php $rpOff = !empty($rp['offline']); ?>
                    <<?php echo e($rpOff ? 'div' : 'a'); ?> <?php if(!$rpOff): ?> href="<?php echo e($rp['url']); ?>" target="_blank" rel="noopener" <?php endif; ?> class="lp-related-card" <?php if($rpOff): ?> style="cursor:default;opacity:.82;" <?php endif; ?>>
                        <span class="cat"><?php echo e($rp['category']); ?> · <?php echo e($rp['country']); ?></span>
                        <h3><?php echo e($rp['title']); ?></h3>
                        <p><?php echo e(\Illuminate\Support\Str::limit($rp['summary'], 90)); ?></p>
                        <?php if($rpOff): ?>
                            <p style="margin-top:8px;color:var(--text-4);font-size:12px;font-weight:600;"><?php echo e($isAr ? 'الموقع غير متاح حاليا' : 'Site is currently offline'); ?></p>
                        <?php endif; ?>
                    </<?php echo e($rpOff ? 'div' : 'a'); ?>>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<section class="ks-section ks-section--tight">
    <div class="container">
        <div class="ks-shead" style="text-align:start;margin-bottom:var(--sp-5);">
            <span class="ks-eyebrow"><?php echo e($isAr ? 'اقرأ أيضا' : 'Read next'); ?></span>
            <h2><?php echo e($isAr ? 'أدله معمقه في هذا المجال' : 'In-depth guides on this'); ?></h2>
            <p style="margin:0;"><?php echo e($isAr ? 'مقالات عمليه تشرح القرارات والتكاليف قبل أن تتعاقد مع أي شخص.' : 'Practical articles on the decisions and the costs, before you hire anyone.'); ?></p>
        </div>
        <div class="row g-4">
            <?php $__currentLoopData = $guides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-4 col-md-6 ks-fadeup">
                    <a href="<?php echo e(route('blog.show', $g['slug'])); ?>" class="lp-related-card">
                        <span class="cat"><?php echo e($g['category']); ?> · <?php echo e($g['read_time']); ?></span>
                        <h3><?php echo e($g['title']); ?></h3>
                        <p><?php echo e(\Illuminate\Support\Str::limit(strip_tags($g['excerpt']), 100)); ?></p>
                    </a>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <div style="margin-top:var(--sp-5);">
            <a href="<?php echo e(route('blogs')); ?>" class="ks-btn ks-btn--ghost"><?php echo e($isAr ? 'كل المقالات' : 'All articles'); ?> <i class="fa fa-arrow-<?php echo e($isAr ? 'left' : 'right'); ?>"></i></a>
        </div>
    </div>
</section>
<?php endif; ?>
...
<section class="ks-section ks-section--tight">
    <div class="container">
        <div class="ks-shead" style="margin-bottom:var(--sp-5);">
            ...
            <h2><?php echo e($isAr ? 'أسئلة قبل التعاقد' : 'Questions before you hire'); ?></h2>
        </div>
        <div class="lp-faq" style="max-width:820px;margin:0 auto;">
            <?php $__currentLoopData = $faq; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <details <?php if($i === 0): ?> open <?php endif; ?>>
                    <summary><?php echo e($f['q']); ?></summary>
                    <div class="ans"><?php echo e($f['a']); ?></div>
                </details>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<section class="ks-section ks-section--tight">
    <div class="container">
        <div class="home-cta ks-fadeup">
            <h2><?php echo e($isAr ? 'جاهز نبدأ مشروعك؟' : 'Ready to start your project?'); ?></h2>
            <p><?php echo e($isAr ? 'ابعتلي تفاصيل المشروع وهترد عليك خلال 24 ساعة بعرض مكتوب وخطه واضحه. استشاره أولى مجانية.' : 'Send your brief. You will get a written quote and a clear plan within 24 hours. First consultation is free.'); ?></p>
            <div class="home-cta__row">
                <a href="<?php echo e(route('contact')); ?>" class="ks-btn ks-btn--primary"><?php echo e($isAr ? 'احجز استشاره مجانية' : 'Book a free consultation'); ?> <i class="fa fa-arrow-right"></i></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Certificates\khaled\resources\views/pages/landing.blade.php ENDPATH**/ ?>