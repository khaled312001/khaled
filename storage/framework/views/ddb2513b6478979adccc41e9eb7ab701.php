...
?>
<!DOCTYPE html>
<html lang="<?php echo e($khLocale); ?>" dir="<?php echo e($khDir); ?>" itemscope itemtype="https://schema.org/WebSite">
<head>
    <meta charset="UTF-8">
    ...
    <meta name="title" content="<?php echo $__env->yieldContent('title', 'Khaled Ahmed — Senior Full Stack Web Developer'); ?>">
    <meta name="description" content="<?php echo $__env->yieldContent('description', 'Senior full stack web developer with 5+ years experience and 25+ shipped projects across 7 countries. Hire an expert Laravel, React, and Node.js developer for your next web app.'); ?>">
    <meta name="keywords" content="<?php echo $__env->yieldContent('keywords', 'web developer, full stack developer, hire web developer, Laravel developer, React developer, Node.js developer, Khaled Ahmed'); ?>">
    <meta name="author" content="Khaled Ahmed">

    <link rel="canonical" href="<?php echo $__env->yieldContent('canonical', $khCanonical); ?>">
    <link rel="alternate" hreflang="en" href="<?php echo e($khEnUrl); ?>">
    <link rel="alternate" hreflang="ar" href="<?php echo e($khArUrl); ?>">
    
    <?php $__currentLoopData = ['ar-SA', 'ar-AE', 'ar-KW', 'ar-QA', 'ar-BH', 'ar-OM', 'ar-EG']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $khRegion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <link rel="alternate" hreflang="<?php echo e($khRegion); ?>" href="<?php echo e($khArUrl); ?>">
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <?php $__currentLoopData = ['en-AE', 'en-SA', 'en-GB', 'en-US', 'en-CH']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $khRegion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <link rel="alternate" hreflang="<?php echo e($khRegion); ?>" href="<?php echo e($khEnUrl); ?>">
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <link rel="alternate" hreflang="x-default" href="<?php echo e($khEnUrl); ?>">

    
    <meta property="og:type"        content="<?php echo $__env->yieldContent('og_type', 'website'); ?>">
    <meta property="og:url"         content="<?php echo $__env->yieldContent('canonical', $khCanonical); ?>">
    <meta property="og:title"       content="<?php echo $__env->yieldContent('og_title', 'Khaled Ahmed — Senior Full Stack Web Developer'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('og_description', 'Senior full stack web developer. Laravel, React, Node.js. 5+ years, 25+ projects, 7 countries.'); ?>">
    <meta property="og:image"       content="<?php echo $__env->yieldContent('og_image', asset('images/og-cover.webp')); ?>">
    <meta property="og:image:width"  content="1200">
    <meta property="og:image:height" content="630">
    <meta property="og:image:alt"   content="<?php echo $__env->yieldContent('og_image_alt', 'Khaled Ahmed — Senior Full Stack Web Developer'); ?>">
    <meta property="og:site_name"   content="Khaled Ahmed">
    <meta property="og:locale"      content="<?php echo e($khLocale === 'ar' ? 'ar_EG' : 'en_US'); ?>">

    
    <meta name="twitter:card"        content="summary_large_image">
    <meta name="twitter:url"         content="<?php echo $__env->yieldContent('canonical', $khCanonical); ?>">
    <meta name="twitter:title"       content="<?php echo $__env->yieldContent('twitter_title', 'Khaled Ahmed — Senior Full Stack Web Developer'); ?>">
    <meta name="twitter:description" content="<?php echo $__env->yieldContent('twitter_description', 'Senior full stack web developer. Laravel, React, Node.js.'); ?>">
    <meta name="twitter:image"       content="<?php echo $__env->yieldContent('twitter_image', asset('images/og-cover.webp')); ?>">
    <meta name="twitter:image:alt"   content="<?php echo $__env->yieldContent('twitter_image_alt', 'Khaled Ahmed — Senior Full Stack Web Developer'); ?>">

    
    <link rel="icon" type="image/png" href="<?php echo e(asset('images/logo-360w.webp')); ?>">
    <link rel="apple-touch-icon" href="<?php echo e(asset('images/logo-360w.webp')); ?>">
    ...
    ?>
    <?php $__currentLoopData = $khPreloadFonts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $khFont): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <link rel="preload" as="font" type="font/woff2" href="<?php echo e(asset($khFont)); ?>" crossorigin>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>


    
    <?php if (! empty(trim($__env->yieldContent('lcp_image')))): ?>
        <link rel="preload" as="image" href="<?php echo $__env->yieldContent('lcp_image'); ?>" fetchpriority="high">
    <?php endif; ?>
...
@font-face {
    ...
    {"@context":"https://schema.org","@graph":[
      {"@type":"Person","@id":"https://khaledahmed.net/#khaled",
       ...
       "image":"<?php echo e(asset('images/og-cover.webp')); ?>",
...
<a href="https://wa.me/201204593124?text=<?php echo e(urlencode($khLocale === 'ar' ? 'أهلاً خالد، أحب أناقش مشروع تطوير ويب' : 'Hi Khaled, I would like to discuss a web development project')); ?>"
   target="_blank" rel="noopener" class="ks-fab-wa" id="ksFabWa" aria-label="<?php echo e($khLocale === 'ar' ? 'تواصل عبر واتساب' : 'Chat on WhatsApp'); ?>">
    <span class="ks-fab-wa__icon"><i class="fab fa-whatsapp"></i><span class="ks-fab-wa__dot"></span></span>
    <span class="ks-fab-wa__label"><?php echo e($khLocale === 'ar' ? 'تواصل واتساب' : 'Chat on WhatsApp'); ?></span>
</a>
...
<aside class="ks-drawer" id="ksDrawer" aria-hidden="true" inert>
    <div class="ks-drawer__head">
        <a href="<?php echo e(route('home')); ?>" class="ks-nav__brand"><img src="<?php echo e(asset('images/logo-360w.webp')); ?>" alt="Khaled Ahmed"></a>
    ...
    <ul class="ks-drawer__links">
        <li><a href="<?php echo e(route('home')); ?>"      class="<?php echo e(request()->routeIs('home') ? 'is-active' : ''); ?>"><?php echo e(__('site.home')); ?> <i class="fas fa-chevron-<?php echo e($khDir === 'rtl' ? 'left' : 'right'); ?>"></i></a></li>
        <li><a href="<?php echo e(route('about')); ?>"     class="<?php echo e(request()->routeIs('about') ? 'is-active' : ''); ?>"><?php echo e(__('site.about')); ?> <i class="fas fa-chevron-<?php echo e($khDir === 'rtl' ? 'left' : 'right'); ?>"></i></a></li>
        <li><a href="<?php echo e(route('services')); ?>"  class="<?php echo e(request()->routeIs('services') ? 'is-active' : ''); ?>"><?php echo e(__('site.services')); ?> <i class="fas fa-chevron-<?php echo e($khDir === 'rtl' ? 'left' : 'right'); ?>"></i></a></li>
        <li><a href="<?php echo e(route('portfolios')); ?>" class="<?php echo e(request()->routeIs('portfolios') || request()->routeIs('portfolios.category') ? 'is-active' : ''); ?>"><?php echo e(__('site.portfolio')); ?> <i class="fas fa-chevron-<?php echo e($khDir === 'rtl' ? 'left' : 'right'); ?>"></i></a></li>
        <li><a href="<?php echo e(route('blogs')); ?>"     class="<?php echo e(request()->routeIs('blogs') || request()->routeIs('blog.show') || request()->routeIs('blog.category') ? 'is-active' : ''); ?>"><?php echo e(__('site.blog')); ?> <i class="fas fa-chevron-<?php echo e($khDir === 'rtl' ? 'left' : 'right'); ?>"></i></a></li>
        <li><a href="<?php echo e(route('faqs')); ?>"><?php echo e(__('site.faqs') ?? 'FAQs'); ?> <i class="fas fa-chevron-<?php echo e($khDir === 'rtl' ? 'left' : 'right'); ?>"></i></a></li>
        <li><a href="<?php echo e(route('contact')); ?>"   class="<?php echo e(request()->routeIs('contact') ? 'is-active' : ''); ?>"><?php echo e(__('site.contact')); ?> <i class="fas fa-chevron-<?php echo e($khDir === 'rtl' ? 'left' : 'right'); ?>"></i></a></li>
    </ul>
    <div class="ks-drawer__foot">
        <a href="<?php echo e(route('lang.switch', $khOther)); ?>" class="ks-btn ks-btn--ghost" style="justify-content:center;">
            <i class="fas fa-globe"></i> <?php echo e($khOther === 'ar' ? 'العربية' : 'English'); ?>

        </a>
        <a href="<?php echo e(route('contact')); ?>" class="ks-btn ks-btn--primary" style="justify-content:center;">
            <?php echo e(__('site.contact_me')); ?> <i class="fa fa-arrow-right"></i>
        </a>
    </div>
</aside>
