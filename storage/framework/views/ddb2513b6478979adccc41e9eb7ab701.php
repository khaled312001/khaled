...
<head>
    ...
    <link rel="canonical" href="<?php echo $__env->yieldContent('canonical', $absoluteCanonical); ?>">
    <link rel="alternate" hreflang="en" href="<?php echo $__env->yieldContent('canonical', $absoluteCanonical); ?>">
    <link rel="alternate" hreflang="ar" href="<?php echo $__env->yieldContent('canonical', $absoluteCanonical); ?>">
    <link rel="alternate" hreflang="x-default" href="<?php echo $__env->yieldContent('canonical', $absoluteCanonical); ?>">

    <meta property="og:type" content="<?php echo $__env->yieldContent('og_type', 'website'); ?>">
    <meta property="og:url" content="<?php echo $__env->yieldContent('canonical', $absoluteCanonical); ?>">
    ...
    <meta name="twitter:url" content="<?php echo $__env->yieldContent('canonical', $absoluteCanonical); ?>">
...
<div class="page-wrapper" id="wrapper">
    ...
    <?php $khLocale = app()->getLocale(); $khOther = $khLocale === 'ar' ? 'en' : 'ar'; ?>
    ...
    <aside class="kh-drawer" id="khDrawer" role="dialog" aria-modal="true" aria-label="Mobile menu">
        <header class="kh-drawer__brand">
            <div class="kh-drawer__brand-text">
                ...
                <span class="name"><?php echo e($khLocale === 'ar' ? 'القائمه' : 'Menu'); ?></span>
            </div>
        ...
        <nav class="kh-drawer__menu">
            <ul>
                <li><a href="<?php echo e(route('home')); ?>" class="<?php echo e(request()->routeIs('home') ? 'is-current' : ''); ?>">
                    <span class="ico"><i class="fas fa-home"></i></span>
                    <span class="label"><?php echo e(__('site.home')); ?></span>
                    <span class="arrow"><i class="fas fa-chevron-right"></i></span>
                </a></li>
                <li><a href="<?php echo e(route('about')); ?>" class="<?php echo e(request()->routeIs('about') ? 'is-current' : ''); ?>">
                    <span class="ico"><i class="fas fa-user"></i></span>
                    <span class="label"><?php echo e(__('site.about')); ?></span>
                    <span class="arrow"><i class="fas fa-chevron-right"></i></span>
                </a></li>
                <li><a href="<?php echo e(route('services')); ?>" class="<?php echo e(request()->routeIs('services') ? 'is-current' : ''); ?>">
                    <span class="ico"><i class="fas fa-bolt"></i></span>
                    <span class="label"><?php echo e(__('site.services')); ?></span>
                    <span class="arrow"><i class="fas fa-chevron-right"></i></span>
                </a></li>
                <li><a href="<?php echo e(route('portfolios')); ?>" class="<?php echo e(request()->routeIs('portfolios') || request()->routeIs('portfolios.category') ? 'is-current' : ''); ?>">
                    <span class="ico"><i class="fas fa-briefcase"></i></span>
                    <span class="label"><?php echo e(__('site.portfolio')); ?></span>
                    <span class="arrow"><i class="fas fa-chevron-right"></i></span>
                </a></li>
                <li><a href="<?php echo e(route('blogs')); ?>" class="<?php echo e(request()->routeIs('blogs') || request()->routeIs('blog.show') || request()->routeIs('blog.category') ? 'is-current' : ''); ?>">
                    <span class="ico"><i class="fas fa-book-open"></i></span>
                    <span class="label"><?php echo e(__('site.blog')); ?></span>
                    <span class="arrow"><i class="fas fa-chevron-right"></i></span>
                </a></li>
                <li><a href="<?php echo e(route('faqs')); ?>" class="<?php echo e(request()->routeIs('faqs') ? 'is-current' : ''); ?>">
                    <span class="ico"><i class="fas fa-question-circle"></i></span>
                    <span class="label"><?php echo e(__('site.faqs')); ?></span>
                    <span class="arrow"><i class="fas fa-chevron-right"></i></span>
                </a></li>
                <li><a href="<?php echo e(route('contact')); ?>" class="<?php echo e(request()->routeIs('contact') ? 'is-current' : ''); ?>">
                    <span class="ico"><i class="fas fa-envelope"></i></span>
                    <span class="label"><?php echo e(__('site.contact')); ?></span>
                    <span class="arrow"><i class="fas fa-chevron-right"></i></span>
                </a></li>
            </ul>
        </nav>
        ...
        <footer class="kh-drawer__foot">
            <a href="<?php echo e(route('lang.switch', $khOther)); ?>" class="kh-drawer__lang">
                <i class="fas fa-globe"></i>
                <?php echo e($khOther === 'ar' ? 'العربية' : 'English'); ?>

            </a>
            <div class="kh-drawer__cta">
                <a href="tel:+201204593124" class="call">
                    <i class="fas fa-phone-alt"></i>
                    <?php echo e($khLocale === 'ar' ? 'اتصل' : 'Call'); ?>
