...
<?php $__env->startSection('keywords', implode(', ', $post['tags']) . ', Khaled Ahmed'); ?>
...
{"@context":"https://schema.org","@type":"BlogPosting","headline":<?php echo json_encode($post['title'], 15, 512) ?>,"description":<?php echo json_encode($post['excerpt'], 15, 512) ?>,"datePublished":"<?php echo e($post['date']); ?>","dateModified":"<?php echo e($post['updated'] ?? $post['date']); ?>","inLanguage":"<?php echo e($isAr ? 'ar' : 'en'); ?>","wordCount":<?php echo e($khWordCount); ?>,"articleSection":<?php echo json_encode($post['category'], 15, 512) ?>,"author":{"@type":"Person","name":"Khaled Ahmed","url":"https://khaledahmed.net","jobTitle":"Senior Full Stack Web Developer","sameAs":["https://linkedin.com/in/khaled-ahmed-82368819b","https://github.com/khaled312001"]},"publisher":{"@type":"Organization","name":"Khaled Ahmed","logo":{"@type":"ImageObject","url":"<?php echo e(asset('images/logo.webp')); ?>"}},"mainEntityOfPage":{"@type":"WebPage","@id":"<?php echo e(route('blog.show', $post['slug'])); ?>"},"keywords":<?php echo json_encode(implode(', ', $post['tags'])) ?>}
</script>
<?php if(!empty($post['faq'])): ?>

<script type="application/ld+json">
{"@context":"https://schema.org","@type":"FAQPage","mainEntity":[<?php $__currentLoopData = $post['faq']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>{"@type":"Question","name":<?php echo json_encode($isAr ? ($f['q_ar'] ?? $f['q']) : $f['q'], 15, 512) ?>,"acceptedAnswer":{"@type":"Answer","text":<?php echo json_encode($isAr ? ($f['a_ar'] ?? $f['a']) : $f['a'], 15, 512) ?>}}<?php if(!$loop->last): ?>,<?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>]}
</script>
<?php endif; ?>
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"<?php echo e(route('home')); ?>"},{"@type":"ListItem","position":2,"name":"Blog","item":"<?php echo e(route('blogs')); ?>"},{"@type":"ListItem","position":3,"name":<?php echo json_encode($post['title'], 15, 512) ?>,"item":"<?php echo e(route('blog.show', $post['slug'])); ?>"}]}
</script>
...
<article>
    <header class="pd-hero">
        <div class="container">
            <div class="pd-bread">
                ...
                <a href="<?php echo e(route('blogs')); ?>"><?php echo e($isAr ? 'المدوّنة' : 'Blog'); ?></a>
                <i class="fas fa-chevron-<?php echo e($isAr ? 'left' : 'right'); ?>"></i>
                <span><?php echo e($post['category']); ?></span>
            </div>
            <span class="pd-cat"><?php echo e($post['category']); ?></span>
            <h1 itemprop="headline"><?php echo e($post['title']); ?></h1>
            <div class="pd-meta">
                <span><i class="far fa-user"></i> Khaled Ahmed</span>
                <span><i class="far fa-calendar"></i> <time datetime="<?php echo e($post['date']); ?>" itemprop="datePublished"><?php echo e(\Carbon\Carbon::parse($post['date'])->locale(app()->getLocale())->translatedFormat($isAr ? 'd F Y' : 'F d, Y')); ?></time></span>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 col-xl-9">
                    ...
                    <section class="pd-faq" aria-labelledby="pd-faq-h">
                        <h2 id="pd-faq-h"><?php echo e($isAr ? 'أسئله شائعه' : 'Frequently asked questions'); ?></h2>
                        <?php $__currentLoopData = $post['faq']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <details <?php if($i === 0): ?> open <?php endif; ?>>
                                <summary><?php echo e($isAr ? ($f['q_ar'] ?? $f['q']) : $f['q']); ?></summary>
                                <div class="ans"><?php echo e($isAr ? ($f['a_ar'] ?? $f['a']) : $f['a']); ?></div>
                            </details>
                    ...
                    <div class="pd-tags">
                        <strong><?php echo e($isAr ? 'كلمات مفتاحية' : 'Tags'); ?>:</strong>
                        <?php $__currentLoopData = $post['tags']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><span><?php echo e($tag); ?></span><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    ...
                    <div class="pd-author" itemscope itemtype="https://schema.org/Person" itemprop="author">
                        ...
                        <div>
                            <h4 itemprop="name"><?php echo e($isAr ? 'كتبه' : 'Written by'); ?> <a href="<?php echo e(route('about')); ?>" itemprop="url">Khaled Ahmed</a></h4>
                            <p itemprop="description"><?php echo e($isAr ? 'مطور ويب Full Stack خبير من القاهرة، أكثر من 5 سنوات خبرة و25 مشروع منشور في 8 دول. مؤسس Barmagly.' : 'Senior full stack web developer based in Cairo with 5+ years of experience and 25+ shipped projects across 8 countries. Founder of Barmagly.'); ?></p>
                            <div class="pd-author__links">
                                <a href="<?php echo e(route('contact')); ?>"><?php echo e($isAr ? 'تواصل معي' : 'Hire me'); ?></a>
                                <a href="<?php echo e(route('services')); ?>"><?php echo e($isAr ? 'الخدمات' : 'Services'); ?></a>
                    ...
                    <div class="home-cta ks-fadeup" style="margin-top: var(--sp-7);">
                        <h2><?php echo e($isAr ? 'مستعد لتطبيق ما قرأته؟' : 'Ready to apply what you just read?'); ?></h2>
                        <p><?php echo e($isAr ? 'استشاره مجانية 30 دقيقة، رد خلال 24 ساعة، وعرض سعر مكتوب.' : 'Free 30-minute consultation, 24-hour response, written fixed-fee quote.'); ?></p>
                        <div class="home-cta__row">
                            <a href="<?php echo e(route('contact')); ?>" class="ks-btn ks-btn--primary"><?php echo e($isAr ? 'احجز استشارة' : 'Book a consultation'); ?> <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="pd-related">
        <div class="container">
            <h2><?php echo e($isAr ? 'مقالات ذات صلة' : 'Related articles'); ?></h2>
            <div class="row g-4 justify-content-center">
                <?php $__currentLoopData = $related; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-4 col-md-6">
                        <a href="<?php echo e(route('blog.show', $rel['slug'])); ?>" class="pd-rel-card">
