<?php $__env->startSection('title', app()->getLocale() === 'ar' ? 'تطوير تطبيقات الويب المخصصه — Laravel و React و Next.js' : 'Custom Web App Development — Laravel, React, Next.js'); ?>
<?php $__env->startSection('description', app()->getLocale() === 'ar' ? 'تطبيقات ويب ومنصات SaaS ومتاجر إلكترونيه وواجهات APIs يبنيها مطور واحد مسؤول. نطاق محدد وسعر ثابت وكود تملكه بالكامل.' : 'Web apps, SaaS platforms, online stores and APIs built by one senior developer. Fixed scope, fixed price, and code you own outright.'); ?>
<?php $__env->startSection('keywords', 'custom web application development services, laravel development services, react development, saas development, ecommerce development, api development, تطوير تطبيقات الويب, برمجة مواقع'); ?>

<?php $__env->startSection('structured_data'); ?>
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"ProfessionalService","name":"Khaled Ahmed — Web Development Services","url":"https://khaledahmed.net/services","image":"<?php echo e(asset('images/logo.webp')); ?>","priceRange":"$$","areaServed":["EG","SA","AE","KW","QA","GB","CH","DE","FR"],"provider":{"@type":"Person","name":"Khaled Ahmed","jobTitle":"Senior Full Stack Web Developer","url":"https://khaledahmed.net","sameAs":["https://linkedin.com/in/khaled-ahmed-82368819b","https://github.com/khaled312001"]},"hasOfferCatalog":{"@type":"OfferCatalog","name":"Web Development Services","itemListElement":[{"@type":"Offer","itemOffered":{"@type":"Service","name":"Laravel Backend Development"}},{"@type":"Offer","itemOffered":{"@type":"Service","name":"React & Next.js Frontend"}},{"@type":"Offer","itemOffered":{"@type":"Service","name":"SaaS MVP Development"}},{"@type":"Offer","itemOffered":{"@type":"Service","name":"E-commerce Solutions"}},{"@type":"Offer","itemOffered":{"@type":"Service","name":"Performance & SEO"}},{"@type":"Offer","itemOffered":{"@type":"Service","name":"Maintenance & DevOps"}},{"@type":"Offer","itemOffered":{"@type":"Service","name":"AI Integration"}},{"@type":"Offer","itemOffered":{"@type":"Service","name":"UI/UX Implementation"}}]}}
</script>
<script type="application/ld+json">
...
<section class="svc-hero">
    <div class="container">
        <div class="d-inline-flex align-items-center gap-2 mb-3" style="font-size:13px;color:var(--text-3);">
            ...
            <span><?php echo e($isAr ? 'الخدمات' : 'Services'); ?></span>
        </div>
        <span class="ks-eyebrow"><span class="ks-dot"></span> <?php echo e($isAr ? 'ما أقدمه' : 'What I deliver'); ?></span>
        <h1 class="mt-3"><?php echo e($isAr ? 'خدمات تطوير ويب' : 'Web development services'); ?> <span class="ks-grad-text"><?php echo e($isAr ? 'تنشر في الإنتاج' : 'that ship to production'); ?></span></h1>
        <p class="lead"><?php echo e($isAr ? 'من تصميم البنية حتى النشر، 8 خدمات متخصصة لمشاريع ويب جادة. سعر ثابت، عرض مكتوب خلال 24 ساعة، ولا مكالمات مبيعات.' : 'From architecture to deployment — 8 specialized services for serious web projects. Fixed-fee quotes, written proposal within 24 hours, no sales calls.'); ?></p>
        <div class="d-flex gap-2 flex-wrap">
            <a href="<?php echo e(route('contact')); ?>" class="ks-btn ks-btn--primary"><?php echo e($isAr ? 'احصل على عرض سعر' : 'Get a quote'); ?> <i class="fa fa-arrow-right"></i></a>
            <a href="<?php echo e(route('portfolios')); ?>" class="ks-btn ks-btn--ghost"><?php echo e($isAr ? 'تصفح أعمالي' : 'See my work'); ?> <i class="fa fa-arrow-right"></i></a>
        </div>
    </div>
</section>
...
<section class="ks-section">
    <div class="container">
        <div class="row g-4">
            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => [$icon, $title, $desc, $items, $stack, $lp, $img]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-6 col-lg-4 ks-fadeup">
                    <div class="svc-card d-flex flex-column">
                        <?php if(!empty($img)): ?>
                            <div class="svc-card__cover">
                                <img src="<?php echo e(asset('images/site/' . $img)); ?>" alt="<?php echo e($title); ?>" width="1536" height="1024" loading="lazy" decoding="async">
                            </div>
                        <?php endif; ?>
                        <div class="svc-card__ico"><i class="<?php echo e($icon); ?>"></i></div>
                        <h3><?php if($lp): ?><a href="<?php echo e(route('landing', $lp)); ?>" style="color:inherit;text-decoration:none;"><?php echo e($title); ?></a><?php else: ?><?php echo e($title); ?><?php endif; ?></h3>
                        <p><?php echo e($desc); ?></p>
                        <ul>
                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li><?php echo e($it); ?></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                        <div class="svc-card__stack"><?php $__currentLoopData = $stack; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><span><?php echo e($s); ?></span><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></div>
                        <a href="<?php echo e($lp ? route('landing', $lp) : route('contact')); ?>" class="svc-card__cta"><?php echo e($lp ? ($isAr ? 'اعرف المزيد' : 'Learn more') : ($isAr ? 'ابدأ مشروع' : 'Start a project')); ?> <i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
...
<section class="ks-section ks-section--tight" style="background: rgba(255,255,255,0.02);">
    <div class="container">
        <div class="ks-shead">
            <span class="ks-eyebrow"><?php echo e($isAr ? 'كيف نشتغل' : 'How it works'); ?></span>
            <h2><?php echo e($isAr ? 'عملية واضحة بأربع خطوات' : 'A simple four-step process'); ?></h2>
            <p><?php echo e($isAr ? 'بدون عقود معقدة. نفس الخطوات التي اتبعتها في كل واحد من 25 مشروع نشرتهم.' : 'No 10-page contracts. The same four steps I used for every one of my 25+ shipped projects.'); ?></p>
        </div>
        <div class="ks-media ks-fadeup" style="max-width: 920px; margin: 0 auto var(--sp-6);">
            <img src="<?php echo e(asset('images/site/process-workflow.webp')); ?>"
                 alt="<?php echo e($isAr ? 'مراحل العمل الأربع: اكتشاف، عرض سعر، تطوير، إطلاق' : 'Four-step delivery process: discovery, quote, build, launch'); ?>"
        ...
        <div class="row g-4">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => [$title, $desc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-6 col-lg-3 ks-fadeup">
                    <div class="svc-step">
                        <div class="svc-step__num"><?php echo e(str_pad($i + 1, 2, '0', STR_PAD_LEFT)); ?></div>
...
<section class="ks-section ks-section--tight">
    <div class="container">
        <div class="ks-shead">
            <span class="ks-eyebrow"><?php echo e($isAr ? 'أسئلة شائعة' : 'FAQ'); ?></span>
            <h2><?php echo e($isAr ? 'الأسئلة التي تأتيني قبل التعاقد' : 'Questions I get before signing'); ?></h2>
        </div>
        <div class="svc-faq" style="max-width: 820px; margin: 0 auto;">
            <?php $__currentLoopData = [
                ...
                <details>
                    ...
                    <div class="ans"><?php echo e($a); ?></div>
                </details>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
?>
<?php if(count($svcPosts)): ?>
<section class="ks-section ks-section--tight" style="background: rgba(255,255,255,0.02);">
    <div class="container">
        <div class="ks-shead ks-fadeup">
            <span class="ks-eyebrow"><?php echo e($isAr ? 'أدله مرجعيه' : 'Reference guides'); ?></span>
            <h2><?php echo e($isAr ? 'كيف أتخذ هذه القرارات فعليا' : 'How I actually make these decisions'); ?></h2>
            <p><?php echo e($isAr ? 'كل خدمه هنا تقف خلفها مقالات تشرح المفاضلات والتكاليف بالتفصيل.' : 'Every service here is backed by a written guide explaining the tradeoffs and the costs.'); ?></p>
        </div>
        <div class="d-flex flex-wrap" style="gap:10px;max-width:1000px;margin:0 auto;">
            <?php $__currentLoopData = $svcPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('blog.show', $sp['slug'])); ?>" class="ks-chip" style="text-decoration:none;">
                    <i class="fas fa-book-open"></i> <?php echo e(\Illuminate\Support\Str::limit($sp['title'], 58)); ?>
...
<section class="ks-section ks-section--tight">
    <div class="container">
        <div class="home-cta ks-fadeup">
            <h2><?php echo e($isAr ? 'لديك مشروع في بالك؟' : 'Have a project in mind?'); ?></h2>
            <p><?php echo e($isAr ? 'أرسل ملف المشروع، وستحصل على رأي صريح، عرض ثابت السعر، وجدول زمني واقعي خلال 24 ساعة. دون التزام.' : 'Send the project brief. You will get an honest assessment, a fixed-fee quote, and a realistic timeline within 24 hours. No commitment.'); ?></p>
            <div class="home-cta__row">
                <a href="<?php echo e(route('contact')); ?>" class="ks-btn ks-btn--primary"><?php echo e($isAr ? 'ابدأ مشروع' : 'Start a project'); ?> <i class="fa fa-arrow-right"></i></a>
                <a href="<?php echo e(route('portfolios')); ?>" class="ks-btn ks-btn--ghost"><?php echo e($isAr ? 'تصفح الأعمال' : 'View portfolio'); ?> <i class="fa fa-arrow-right"></i></a>
            </div>
        </div>
    </div>
</section>
