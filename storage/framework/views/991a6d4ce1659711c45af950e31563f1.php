<?php $__env->startSection('title', isset($category) ? ucfirst($category) . ' Projects | Khaled Ahmed Portfolio' : 'Portfolio — 28 Real Projects Shipped Across 7 Countries | Khaled Ahmed'); ?>
<?php $__env->startSection('description', isset($category) ? 'See ' . strtolower($category) . ' web development projects shipped by Khaled Ahmed — senior full stack developer.' : '28 real production projects shipped across 7 countries — Laravel, React, Node.js. SaaS, e-commerce, restaurants, hotels, healthcare, education and more.'); ?>
...
<script type="application/ld+json">
{
    ...
    "description": "28 real production projects shipped across 7 countries.",
    "url": "<?php echo e(url('/portfolios')); ?>",
    "isPartOf": {"@type":"WebSite","name":"Khaled Ahmed","url":"https://khaledahmed.net"},
    "mainEntity": {
        "@type": "ItemList",
        "numberOfItems": <?php echo e(count($projects)); ?>,
        "itemListElement": [
            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            {
                "@type": "ListItem",
                "position": <?php echo e($i + 1); ?>,
                "item": {
                    "@type": "CreativeWork",
                    "name": <?php echo json_encode($p['title'], 15, 512) ?>,
                    "description": <?php echo json_encode($p['summary'], 15, 512) ?>,
                    "url": <?php echo json_encode($p['url'], 15, 512) ?>,
...
<script type="application/ld+json">
{
    ...
    "itemListElement": [
        ...
        {"@type":"ListItem","position":2,"name":"Portfolio","item":"<?php echo e(url('/portfolios')); ?>"}
        <?php if(isset($category)): ?>,{"@type":"ListItem","position":3,"name":"<?php echo e(ucfirst($category)); ?>","item":"<?php echo e(url('/portfolio/category/' . $category)); ?>"}<?php endif; ?>
    ]
}
</script>
...
<section class="portfolio-hero">
    <div class="container">
        <?php if(isset($category)): ?>
            <h1><?php echo e(ucfirst(str_replace('-', ' ', $category))); ?> Projects</h1>
            <p>Real production work in <strong><?php echo e(strtolower(str_replace('-', ' ', $category))); ?></strong> — built and shipped by Khaled Ahmed.</p>
        <?php else: ?>
            <h1>Portfolio — Real Projects, Real Results</h1>
            <p>28 production projects shipped across 7 countries. Click any card to see the live site — these are real businesses serving real customers right now.</p>
            <div class="portfolio-stats">
                <div class="stat"><div class="num">28</div><div class="lbl">Live Projects</div></div>
                <div class="stat"><div class="num">7</div><div class="lbl">Countries</div></div>
                <div class="stat"><div class="num"><?php echo e(count($categories)); ?></div><div class="lbl">Industries</div></div>
                <div class="stat"><div class="num">5+</div><div class="lbl">Years</div></div>
            </div>
        <?php endif; ?>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <article class="project-card" tabindex="0">
                    <a href="<?php echo e($project['url']); ?>" target="_blank" rel="noopener" class="project-img" aria-label="Visit <?php echo e($project['title']); ?>">
                        <img src="<?php echo e(asset('images/' . $project['image'])); ?>"
                    ...
                    <div class="project-body">
                        <div class="cat"><?php echo e($project['category']); ?></div>
                        <h3><?php echo e($project['title']); ?></h3>
                        <p class="summary"><?php echo e($project['summary']); ?></p>
                        <div class="tech-stack">
                            <?php $__currentLoopData = $project['tech']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php else: ?>
            <div class="text-center py-5">
                ...
                <a href="<?php echo e(route('portfolios')); ?>" class="primary-btn"><span class="text">View All Projects</span><span class="icon"><i class="fa fa-arrow-right"></i></span></a>
            </div>
        <?php endif; ?>

        <div class="portfolio-cta">
            <h2>Want to Be Project #29?</h2>
            <p>I take 2–3 new clients per quarter. If you have a serious project, let's talk — free 30-minute consultation, 24-hour response.</p>
            <a href="<?php echo e(route('contact')); ?>" class="btn-cta">Start Your Project <i class="fa fa-arrow-right ms-2"></i></a>
        </div>
    </div>
</section>
<?php $__env->stopSection(); ?>
