        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay="0.1s">
                <div class="services-item">
                    <img src="<?php echo e(asset('images/1710763075-services-bg-img-1.jpg')); ?>" alt="Services image" class="services-bg-img">
                    <div class="body">
                    <h4>01</h4>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay="0.2s">
                <div class="services-item">
                    <img src="<?php echo e(asset('images/1710763115-services-bg-img-2.jpg')); ?>" alt="Services image" class="services-bg-img">
                    <div class="body">
                    <h4>02</h4>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay="0.3s">
                <div class="services-item">
                    <img src="<?php echo e(asset('images/1710763151-services-bg-img-3.jpg')); ?>" alt="Services image" class="services-bg-img">
                    <div class="body">
                    <h4>03</h4>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\AIA\Downloads\khaled\resources\views/pages/services.blade.php ENDPATH**/ ?>