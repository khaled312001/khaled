        ...
        <div class="row">
            <div class="col-md-12">
                <div class="text-center mb-5 custom-category-link">
                    <a href="<?php echo e(route('portfolios')); ?>" class="current mb-2">All Portfolio</a>
                </div>
            </div>
        </div>
                ...
                <div class="portfolio-item-inner">
                    <div class="portfolio-item-img">
                        <img 
                            ...
                            onerror="this.onerror=null;this.src='<?php echo e(asset('images/projects/placeholder.jpg')); ?>';"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\AIA\Downloads\khaled\resources\views/pages/portfolios.blade.php ENDPATH**/ ?>